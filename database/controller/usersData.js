        ...
        async function create_(userID, userInfo) {
                ...
                const queue = new Promise(async function (resolve_, reject_) {
                        try {
                                ...
                                userInfo = userInfo || (await api.getUserInfo(userID))[userID] || { name: "user", gender: "unknown", vanity: "unknown" };
                                let userData = {
                                        userID,
                ...
                return new Promise(async function (resolve, reject) {
                        taskQueue.push(async function () {
                                try {
                                        ...
                                        updateInfoUser = updateInfoUser || (await api.getUserInfo(userID))[userID] || { name: "user", vanity: "unknown", gender: "unknown" };
